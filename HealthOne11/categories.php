            ...
            <div class="col-sm-4 col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        </a><div class="card-title mb-3"><a href="roeitrainers.php" class="badge badge-primary">Roeitrainers</a></div>
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="card-title mb-3"><a href="crosstrainers.php" class="badge badge-primary">Crosstrainers</a></div>
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="card-title mb-3"><a href="hometrainers.php" class="badge badge-primary">Hometrainers</a></div>
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="card-title mb-3"><a href="Loopbanden.php" class="badge badge-primary">Loopbanden</a></div>
                        </div>
